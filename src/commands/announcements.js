...
const ANN  = fs2.existsSync(P.announce) ? P.announce : P.announceDef;
const ARC  = require('path').join(P.vault, 'announcementsArchive.txt');
let _last  = '';
...
module.exports = {
  name:'announcements',
  requirePrefix: true, aliases:['announce','urgent'], permissions:'mod', cooldown:false,
