...
const MoraleMeter = {
  ...
  _buildInSceneBowls() {
    ...
    this._foodEl = this._makeBowl('food','🍗 FOOD','#D4774B','rgba(220,150,50,.75)', 'left:36px;bottom:205px');
    // Water bowl — left side of yard (active players drain it)
    this._waterEl= this._makeBowl('water','💧 WATER','#2980b9','rgba(52,152,219,.75)','left:120px;bottom:205px');
