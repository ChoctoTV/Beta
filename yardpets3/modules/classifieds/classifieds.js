    ...
    this._showSpotlight = async (nft, index) => {
      ...
      this._spotlight.innerHTML = `
        ...
        <div id="__spl" style="
          ...
          background:radial-gradient(ellipse at center, rgba(0,0,0,.6) 0%, rgba(0,0,0,.88) 100%);
    ...
    this._showFavPupCard = async (nft, requestedBy) => {
      ...
      this._spotlight.innerHTML = `
        ...
        <div id="__spl" style="
          ...
          <div style="position:absolute;bottom:32px;font-size:14px;color:rgba(255,255,255,.35);letter-spacing:.08em;">
            AUTO-DISMISS IN 15s
          </div>
        </div>`;
